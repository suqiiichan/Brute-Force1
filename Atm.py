...
while kondisi:
    ...
    if pilih == "1":
        ...
        while kondisi7:
            ...
            if milih == "1":
                no_rekening = int(input("Masukkan Nomer Rekening yang anda: "))
                ...
                kode_pengirim = int(input("Masukan Nomer Rekening Anda: "))
                kode_penerima = int(input("Masukkan Nomer Rekening yang anda tujuh: "))
                jumlah_uang = int(input("Jumlah yang ingin anda transferkan: "))
                a = tabungan[kode_pengirim] - jumlah_uang
                b = tabungan[kode_penerima] + jumlah_uang
                tabungan[kode_pengirim] = a
                tabungan[kode_penerima] = b
                print(tabungan)
            kondisi8 = True
            while kondisi8:
